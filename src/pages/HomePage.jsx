  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-green-300 to-blue-500 text-white">
      <header className="text-center mb-8">
        ...
        <p className="text-xl font-light tracking-wide">Fostering innovation and collaboration for a sustainable future.</p>
      </header>
      <main className="flex flex-col items-center space-y-6">
        ...
        <div className="text-center mt-8">
          <p className="text-sm font-light">Discover how we empower creativity and drive impactful innovation globally.</p>
        </div>
      </main>
